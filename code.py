# Before starting coding program we need to know pseudocode of finding shortest distance
# Pseudocode:
"""
while any vertex remains unvisited:
    visit unvisited vertex with smallest known distance from the staring vertex. Let's call it current_vertex
    for each unvisited neighbor of current_vertex:
        calculate new distance from start vertex if this route is taken
